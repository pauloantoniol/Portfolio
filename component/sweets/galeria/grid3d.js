...
;( function( window ) {
	...
	grid3D.prototype._init = function() {
		...
		// content
		this.contentEl = this.el.querySelector( 'div.galeria' );
		// content items
		this.contentItems = [].slice.call( this.contentEl.children );
		// close content cross
		this.close = this.contentEl.querySelector( 'span.close-galeria' );
		// loading indicator
	...
	grid3D.prototype._hideContent = function() {
		var self = this,
			contentItem = this.el.querySelector( 'div.galeria > .show' ),
